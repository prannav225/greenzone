...
export default function WhatHappensNext() {
  return (
    <div className="space-y-8">
      ...
      <div className="space-y-8 border-l border-white/10 pl-5 sm:pl-8 ml-2 sm:ml-4">
        {PROCESS_STEPS.map((step, idx) => (
          <div key={idx} className="relative">
            <div className="absolute -left-[29px] sm:-left-[41px] top-0 w-4 h-4 rounded-full bg-accent-gold border-4 border-forest-deep shadow-gold animate-pulse" />

...
const DateStep = ({
  ...
  return (
    <div className="animate-fade-in space-y-4 lg:space-y-8">
      <div className="p-5 lg:p-8 bg-white/5 border border-white/10 rounded-[32px] lg:rounded-[40px] space-y-6 lg:space-y-8">

      ...
      <div className="relative max-w-7xl mx-auto px-6 lg:px-12 pt-20 pb-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-16 lg:gap-12 mb-20">
          ...
          <div className="lg:col-span-5 space-y-8">
            ...
            <p className="text-sm leading-relaxed text-white/70 max-w-sm normal-case font-medium tracking-normal mb-8">
              Crafting immersive, slow-travel experiences across the powerful
              landscapes of the Western Ghats and beyond. We curate moments of
              deep clarity, intentional pacing, and silent discovery.
            </p>
            ...
            <div className="flex gap-4">
              {navigation.social.map((social) => (
                ...
                >
                  <social.icon className="w-4 h-4 text-white/60 group-hover/icon:text-forest-deep transition-colors" />
                </a>
              ))}
            </div>
          </div>
          ...
          <div className="lg:col-span-3 space-y-8">
            <h4 className="text-[10px] uppercase font-bold text-white/50 tracking-[0.4em]">
              Directory
            </h4>
            <nav className="flex flex-col gap-4">
              {navigation.company.map((link) => (
                <Link
                  key={link.path}
                  to={link.path}
                  className={`group flex items-center gap-2 text-xs uppercase font-bold transition-colors ${
                    isActive(link.path)
                      ? "text-accent-gold"
          ...
          <div className="lg:col-span-4 space-y-8">
            ...
            <div className="space-y-6">
              <div className="flex items-start gap-4">
                ...
                <span className="text-xs leading-relaxed text-white/60 normal-case font-medium tracking-normal">
                  Bengaluru, Karnataka,
                  <br />
                  India
                </span>
              ...
              <div className="flex items-center gap-4 group cursor-pointer">
                ...
                <span className="text-xs text-white/60 group-hover:text-white transition-colors lowercase tracking-normal">
                  hello@greenzone.com
                </span>
              </div>
              <div className="flex items-center gap-4 group cursor-pointer">
                <Phone className="w-4 h-4 text-accent-gold shrink-0" />
                <span className="text-xs text-white/60 group-hover:text-white transition-colors tracking-normal">
                  +91 70199 71407
                </span>
              </div>
            </div>
